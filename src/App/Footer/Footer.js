  ...
  return (
    <div className="Footer">
		<div className="Col">
			...
			<p>
				<a onClick={()=> window.location = "https://facebook.com"}><span className="fa fa-facebook social-media"></span></a>
				<a onClick={()=> window.location = "https://twitter.com"}><span className="fa fa-twitter social-media"></span></a>
				<a onClick={()=> window.location = "https://instagram.com"}><span className="fa fa-instagram social-media"></span></a>
			</p>
		</div>
